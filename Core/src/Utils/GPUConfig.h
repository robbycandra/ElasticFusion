...
class GPUConfig
{
    ...
    private:
           ...
           so3StepBlocks(64)
        {
            ...
            icpStepMap["GeForce 930MX"] = std::pair<int, int>(64, 48);
            rgbStepMap["GeForce 930MX"] = std::pair<int, int>(64, 32);
            rgbResMap["GeForce 930MX"] = std::pair<int, int>(128, 48);
            so3StepMap["GeForce 930MX"] = std::pair<int, int>(128, 16);
